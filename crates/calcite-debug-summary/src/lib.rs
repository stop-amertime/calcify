...
mod tests {
    ...
    fn test_state() -> State {
        let css = r#"
            ...
            @property --memAddr0   { syntax: "<integer>"; inherits: true; initial-value: 0; }
            @property --memVal0    { syntax: "<integer>"; inherits: true; initial-value: 0; }
        "#;
    ...
    fn set(s: &mut State, name: &str, v: i32) {
        assert!(s.set_var(name, v), "state var {name} not registered");
    }
